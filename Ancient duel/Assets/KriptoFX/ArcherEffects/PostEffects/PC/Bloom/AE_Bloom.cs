...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    [AddComponentMenu("Image Effects/Cinematic/AE_Bloom")]
#if UNITY_5_4_OR_NEWER
    [ImageEffectAllowedInSceneView]
#endif
    public class AE_Bloom : MonoBehaviour
    {
        [Serializable]
        public struct Settings
        {
            ...
            [AE_MinAttribute(0f), Tooltip("Amount of lens dirtiness.")]
        ...
        public Shader shader
        {
            get
            {
                if (m_Shader == null)
                {
                    const string shaderName = "Hidden/Image Effects/Cinematic/AE_Bloom";
        ...
        public Material material
        {
            ...
            {
                if (m_Material == null)
                    m_Material = AE_ImageEffectHelper.CheckShaderAndCreateMaterial(shader);
        ...
        {
            if (!AE_ImageEffectHelper.IsSupported(shader, true, false, this))
                enabled = false;
        }
