...
[AddComponentMenu("KriptoFX/AE_BloomAndDistortion")]
#if UNITY_5_4_OR_NEWER
//[ImageEffectAllowedInSceneView]
#endif
public class AE_DistortionAndBloom : MonoBehaviour
{
    ...
    const string shaderAdditiveName = "Hidden/KriptoFX/PostEffects/AE_BloomAdditive";
    ...
    private void UpdateBloom()
    {
        ...
        mat.SetTexture("_BaseTex", source);
